...
class Administracion extends Controller
{
    ...
    {
        // if (Auth::user()->hasPermissionTo('catalogo')) {
       // $roles = Role::all();
       ...
       // return $user;
        ...
        //  }else{return "no tiene ese privilegio";
        // };
    }
    ...
    {   
       ...
       return view('administracion/permisos/index',compact('role','permisos','id'));
