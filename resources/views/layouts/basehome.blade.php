...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="hold-transition layout-top-nav">
        <div class="wrapper">
          ...
          <!-- Navbar -->
          <nav class="main-header navbar navbar-expand-md navbar-light bg-dark navbar-white">
     ...
                      </form>
        ...
        <!-- jQuery -->
        <script src="{{asset('/libreria/jquery/jquery.min.js')}}"></script>
        <!-- Bootstrap 4 -->
        <script src="{{asset('/libreria/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
        <!-- AdminLTE App -->
