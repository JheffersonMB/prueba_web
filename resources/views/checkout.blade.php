...
<div class="content-wrapper">
  ...
  <div class="content-header">
    ...
    <div class="container">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0"> Detalle de pedidos</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-12">
            ...
            <div class="card card-dark bg-dark shadow-md">
                ...
                <div class="card-header">
                  ...
                  <div class="card-body">
                    ...
                    @else --}}
                      <!-- /input-group -->
                      <form method="POST" id="miform" action="" autocomplete="off">
                        @csrf
                        ...
                        <div class="row row-cols-1 row-cols-sm-2  row-cols-md-3 g-3">
                          ...
                          <div class="col">
                            <div class="form-group">
                              ...
                              <input class="form-control form-control-sm" id="apellidos" name="apellidos" type="text"  value="{{$cliente['apellido_cliente']}}" disabled/>
                            </div>
                          </div>
                            ...
                            <div class="col">
                              <div class="form-group">
                                ...
                                <input class="form-control form-control-sm" id="telefono" name="telefono" type="tel" value="{{$cliente['telefono_cliente']}}" disabled/>
                              </div>
                            </div>
