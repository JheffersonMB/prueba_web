                ...
                <div class="card-body">
                    <div class="d-flex justify-content-end">
                        <div class="form-group">
                            <a href="{{ route('empleado.create') }}" class="btn btn-info btn-sm">crear registro</a>
                        </div>
                    </div>
                                 ...
                                 <tr>
                                     ...
                                     <td class="py-1 align-middle text-center">
                                        <div class="btn-group btn-group-sm">
                                          <a class="btn btn-warning" rel="tooltip" data-placement="top" title="Editar" href="{{ url('empleado/edit/'.$empleado->id)}}"><i class="fas fa-pencil-alt"></i></a>
                                          ...
                                          <a class="btn btn-danger"  title="Eliminar" href="{{url('empleado/destroy/'.$empleado->id)}}"><i class="fas fa-trash"></i></a>
                                        </div>
                                      </td>
                                 </tr> 
                            @endforeach
